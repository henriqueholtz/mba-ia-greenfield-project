...
import { CreateVideos1789408683738 } from './migrations/1789408683738-CreateVideos';
...
describe('Database migrations (integration)', () => {
  ...
  it('should revert the last migration and remove the videos table without affecting channels/users', async () => {
